...
export const metadata: Metadata = {
  title: 'Harvesters HICC — Leadership Platform',
  description: 'Growth analytics, retention heatmaps, community and pastoral management for Harvesters International Christian Centre',
